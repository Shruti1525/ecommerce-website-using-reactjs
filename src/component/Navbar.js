    ...
    <>
      ...
      >
        <div className="container-fluid nav-main  fixed-top container-fluid px-4 px-md-5">
          ...
          <input
            className="nav-search me-4 ps-2 "
            type="search"
            placeholder="Search"
            aria-label="Search"
          />
          ...
          <a href="/profile">
            <img
              src="https://img.icons8.com/ios-glyphs/30/null/gender-neutral-user.png"
              alt="profile"
            />{" "}
          </a>
          {/* <a href="/wishlist">
          ...
          <a href="/addtocart">
            <button className="cart-button">
              <img
                src="https://img.icons8.com/glyph-neue/64/null/shopping-cart.png"
