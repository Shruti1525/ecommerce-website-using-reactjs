  ...
  return (
    <>
      ...
      <div className="row container-fluid px-4 px-md-5 grid">
        <div className="col-12">
          <img
            src="./assets/homeimages/section1/girl-back-img.png"
            className="img-fluid mb-4 image"
            style={{ height: "600px", width: "1500px" }}
            alt="pic"
          />
          <div className="image-overlay-one">
            <h3 className="overflow-hidden">Women's Fashion</h3>
            <br /> <br />
            <a href="./womens" className="text-white">
              View Products
            </a>
          </div>
        </div>
      ...
      <div className="row container-fluid px-4 px-md-5 grid">
        <div className="col-12">
          <img
            src="./assets/homeimages/section1/men_back_img.png"
            className="img-fluid mb-4 image"
            style={{ height: "600px", width: "1500px" }}
            alt="pic"
          />
          <div className="image-overlay-one"> 
            <h3 className="overflow-hidden">Men's Fashion</h3> <br /> <br />
            <a href="./mens" className="text-white">
              View Products
            </a>
          </div>
        </div>
      ...
      <div className="row container-fluid px-4 px-md-5 grid">
        <div className="col-12">
          <img
            src="./assets/homeimages/section1/kid-back-img.png"
            className="img-fluid mb-4 image"
            style={{ height: "600px", width: "1500px" }}
            alt="pic"
          />
          <div className="image-overlay-one">
            <h3 className="overflow-hidden">Kid's Fashion</h3>
            <br /> <br />
            <a href="./kids" className="text-white">
              View Products
            </a>
          </div>
        </div>
      ...
      <div className="row container-fluid px-4 px-md-5 grid">
        <div className="col-12">
          <img
            src="./assets/homeimages/section1/beauty_back_img.png"
            className="img-fluid mb-4 image"
            style={{ height: "600px", width: "1500px" }}
            alt="pic"
          />
          <div className="image-overlay-one">
            <h3 className="overflow-hidden">Beauty</h3>
            <br /> <br />
              ...
              <div className="d-inline">
                <a href={item.link}>
                  <img
                    src={item.picture}
                    alt="pic"
                    className="img-fluid brand-pic mx-4"
                  />
                </a>
              </div>
            ))}
